...
if "generated_email" in st.session_state:
    ...
    st.session_state["email_subject"] = st.text_input("Email Subject", value=st.session_state["email_subject"], key="subject_edit")
    st.session_state["generated_email"] = st.text_area("Email Body", value=st.session_state["generated_email"], height=400, key="body_edit")
